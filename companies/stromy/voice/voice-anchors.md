# Stromy Voice Anchors (L2)

Ground-truth reference passages for the Stromy voice. Treat these as
...
> regulatory window closed earlier than the sector planned for. None of that is
...
> cheaper on the slide and fails in week three.

## Notes

- No hype words, no exclamation marks, no em-dashes.
- Conclusion first, evidence second.
- Plain, specific nouns. Active voice.
