...
<!--
  ...
  Source:      MCPs/media-gen-mcp/skills/media-social-pack/SKILL.md
...
1. Read the main skill instructions:
   → call the `fs_read` tool on the `media-gen` MCP with `path="skills/media-social-pack/SKILL.md"`.

2. Discover reference files (and any other skill assets), then read on demand:
   → call `fs_list` with `path="skills/media-social-pack"` (and `path="skills/media-social-pack/references"`),
   → call `fs_read` with `path="skills/media-social-pack/references/<file>"`.
